...
*/
    ...
    Attach("~/AbVarFq_LMFDBLabels/packages/padictocc_pari-gp.m"); // this overwrites one intrinsic to force
                                                                      // the use of pari-gp to compute the
                                                                      // SplittingField and IsSquare
